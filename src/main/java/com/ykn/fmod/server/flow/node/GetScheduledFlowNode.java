...
public class GetScheduledFlowNode extends FlowNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Text displayName = Util.parseTranslatableText("fmod.node.getscheduledflow.title.name");
        Text description = Util.parseTranslatableText("fmod.node.getscheduledflow.title.feat");
