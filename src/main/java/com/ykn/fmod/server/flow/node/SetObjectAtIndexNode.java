...
public class SetObjectAtIndexNode extends FlowNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Text displayName = Util.parseTranslatableText("fmod.node.setindexat.title.name");
        Text description = Util.parseTranslatableText("fmod.node.setindexat.title.feat");
