...
public class NodeStatus implements Cloneable {
    ...
    /**
     * Checks if this node has been executed.
     * 
    ...
    /**
     * Gets the FlowNode associated with this status.
     * <p>
     * This is a reference to the actual node, not a copy.
     * 
     * @return The FlowNode this status tracks
     */
    ...
    /**
     * Gets an unmodifiable list of the current input values for this node.
     * <p>
     * Each element corresponds to an input port on the node.
     * Values are resolved from DataReferences before execution.
     * 
     * @return An unmodifiable list of input values
     */
    ...
    /**
     * Sets the input values for this node.
     * <p>
     * The provided list should have the same number of elements as the node's input ports.
     * Values are typically resolved from DataReferences before being set here.
     * 
     * @param inputs The list of input values to set (must match the number of input ports)
     */
    public void setInputs(List<Object> inputs) {
        if (inputs.size() != this.node.metadata.inputNumber) {
            Util.LOGGER.warn("FMinecraftMod: Attempted to set inputs for node " + this.node.name + " with incorrect number of inputs: expected " + this.node.metadata.inputNumber + ", got " + inputs.size());
        }
    ...
    /**
     * Gets an unmodifiable list of the current output values for this node.
     * <p>
     * Each element corresponds to an output port on the node.
     * Values are set by the node during {@link FlowNode#onExecute}.
     * 
     * @return An unmodifiable list of output values
     */
    ...
    /**
     * Gets the ID of the next node to execute (the branch taken).
     * <p>
     * Set by the node during execution. If -1, it means no next node or not yet executed.
     * 
     * @return The ID of the next node to execute, or -1 if none/not executed
     */
    ...
    /**
    * Sets the ID of the next node to execute (the branch taken).
    * <p>
    * Called by nodes during execution to determine the next node in the execution path.
    * 
    * @param nextBranchId The ID of the next node to execute, or -1 if none
    */
