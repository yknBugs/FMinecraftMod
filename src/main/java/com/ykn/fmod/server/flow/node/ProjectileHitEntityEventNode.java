...
public class ProjectileHitEntityEventNode extends EventNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Text displayName = Util.parseTranslatableText("fmod.node.pentityevt.title.name");
        Text description = Util.parseTranslatableText("fmod.node.pentityevt.title.feat");
