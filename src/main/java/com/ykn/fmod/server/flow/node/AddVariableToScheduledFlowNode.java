...
public class AddVariableToScheduledFlowNode extends FlowNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Text displayName = Util.parseTranslatableText("fmod.node.addvarflow.title.name");
        Text description = Util.parseTranslatableText("fmod.node.addvarflow.title.feat");
