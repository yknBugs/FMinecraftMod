...
public class ExecuteCommandNode extends FlowNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Component displayName = Util.parseTranslatableText("fmod.node.runcommand.title.name");
        Component description = Util.parseTranslatableText("fmod.node.runcommand.title.feat");
