...
public class GetObjectAtIndexNode extends FlowNode {
    ...
    protected NodeMetadata createMetadata(int inputNumber, int outputNumber, int branchNumber) {
        Component displayName = Util.parseTranslatableText("fmod.node.getindexat.title.name");
        Component description = Util.parseTranslatableText("fmod.node.getindexat.title.feat");
